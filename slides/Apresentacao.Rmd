...
+ é mais simples do que $\LaTeX$ - e para muitas coisas isso é suficiente
--
...
# Gestão de bibliografia em rmarkdown (e $\LaTeX$)
...
+ Gestor de bibliografia __de código aberto__
--
...
- __resista a tentação__ de fazer um documento só com todo o código: scripts e outputs separados do documento. __flexibilidade__ no formato final.
